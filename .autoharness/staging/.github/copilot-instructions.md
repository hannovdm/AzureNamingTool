...
(see AGENTS.md technology table)

## Project Structure

```text
src/ (Components, Controllers, Services, Repositories, Models, Helpers, Data, Middleware, Attributes, HealthChecks, repository, settings); tests/ (UnitTests, UiTests); docs/v5.0.0/adrs/; infra/.
```
...
PascalCase for types/members; camelCase for locals; interfaces prefixed I; async methods suffixed Async.
