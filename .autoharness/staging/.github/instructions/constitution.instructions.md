...
No unsafe blocks; respect <Nullable>enable</Nullable>. Build with no NEW analyzer warnings. Repo currently suppresses CS8602/CS8600/CS1998 -- do not widen suppression list without ADR.. All exceptions MUST be typed, logged via LogHelper, and translated at controller boundaries. v2 endpoints return ApiResponse<T>..
