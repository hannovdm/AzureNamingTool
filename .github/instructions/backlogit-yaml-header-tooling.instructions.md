...
Call `backlogit_sync_index` after any direct file edit in `.backlog/`. The index cache becomes stale if artifacts are modified outside the MCP or CLI surfaces.
